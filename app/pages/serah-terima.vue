...
useHead({
  title: "Serah Terima Pasien - Vanara Admin",
});
...
const progressMutasi = computed(() => {
  ...
  const checked = mutasiChecklist.value.filter((i) => i.required && i.checked).length;
  return Math.round((checked / required) * 100);
});

const progressTimbangTerima = computed(() => {
  const critical = timbangTerimaChecklist.value.filter((i) => i.critical).length;
  const checked = timbangTerimaChecklist.value.filter((i) => i.critical && i.checked)
    .length;
...
const completeHandover = () => {
  ...
  alert("Serah terima perawat berhasil diselesaikan! Pasien siap masuk ruang operasi.");
};
    ...
    <div class="flex items-center justify-between mb-8">
      <div class="flex items-center gap-4">
        ...
        <div class="hidden sm:block">
          <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Fase 1</p>
          <p class="font-semibold text-gray-900 dark:text-gray-100">Mutasi IRNA → OK</p>
        </div>
      </div>
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="hidden sm:block text-right">
          <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Fase 2</p>
          <p class="font-semibold text-gray-900 dark:text-gray-100">Timbang Terima</p>
        </div>
      </div>
    </div>

    <!-- ==================== FASE 1: MUTASI IRNA KE OK ==================== -->
    <div v-if="currentPhase === 'mutasi'" class="space-y-6 animate-fade-in">
      <!-- Patient Info Card -->
      <UCard
        ...
        >
            ...
            <div>
              ...
              >
                ...
                <span class="dark:text-gray-300"
                  >{{ patientData.age }} th, {{ patientData.gender }}</span
                >
          ...
          <div class="text-right space-y-2">
            ...
            <div class="text-sm text-gray-500 dark:text-gray-400">
              ...
              <p v-if="patientData.timeOut">Selesai: {{ patientData.timeOut }}</p>
            </div>
          </div>
        </div>
      </UCard>
        ...
        <div class="flex-1">
          <div class="flex justify-between text-sm mb-2">
            <span class="font-medium text-gray-700 dark:text-gray-300"
              >Progress Kelengkapan (Wajib)</span
            >
          ...
          <UProgress :value="progressMutasi" color="primary" size="lg" />
        </div>

        <UBadge
          :color="patientData.status === 'Terverifikasi' ? 'success' : 'warning'"
          variant="soft"
          size="lg"
      ...
      >
        ...
        <template #header>
          <div class="flex items-center justify-between py-2">
            ...
            <UButton variant="ghost" color="neutral" size="sm" @click="resetMutasi">
              Reset
            </UButton>
          </div>
        </template>
        ...
        <div class="space-y-6">
          ...
          >
            ...
            >
              <span class="w-2 h-2 rounded-full bg-gray-300 dark:bg-slate-600" />
              {{ category }}
            </h3>

            <div class="space-y-2">
              <div
                v-for="item in mutasiChecklist.filter((i) => i.category === category)"
                :key="item.id"
        ...
        <template #footer>
          <div class="flex justify-end gap-3 py-2">
            <UButton variant="soft" color="neutral" size="lg" @click="resetMutasi">
              Reset Checklist
            </UButton>
      ...
      >
        ...
        >
          ...
          <div class="text-sm text-blue-800 dark:text-blue-200">
            ...
            <p>
              Semua logistik harus tersedia sebelum pasien dapat dipindahkan ke area OK.
              Jika ada keterlambatan logistik, segera hubungi koordinator OK.
            </p>
          </div>
        </div>
      </UCard>
    ...
    <div v-else class="space-y-6 animate-fade-in">
        ...
        >
          <div>
            <div class="flex items-center gap-2 mb-2">
              <UBadge color="success" variant="soft" size="sm"> Fase 2 </UBadge>
      ...
      >
        <div class="flex-1">
          <div class="flex justify-between text-sm mb-2">
            <span class="font-medium text-gray-700 dark:text-gray-300"
              >Progress SBAR (Kritis)</span
            >
            <span class="font-bold text-emerald-600 dark:text-emerald-400"
              >{{ progressTimbangTerima }}%</span
            >
          </div>
          <UProgress :value="progressTimbangTerima" color="success" size="lg" />
        </div>
      </div>
              ...
              >
                ...
                <div class="flex-1">
                  <div class="flex items-center gap-2 flex-wrap">
                    ...
                    <UBadge v-if="item.critical" color="error" variant="soft" size="xs">
                      Kritis
                    </UBadge>
                  </div>
                </div>
      ...
      >
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 p-2">
          ...
          <div class="flex gap-3">
            <UButton variant="soft" color="neutral" size="lg" @click="resetTimbangTerima">
              Reset
            </UButton>
            <UButton
              color="success"

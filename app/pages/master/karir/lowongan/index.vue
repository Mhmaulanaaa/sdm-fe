...
const { lowongan, loadData, deleteLowongan } = useLowongan();

const goToTambah = () => {
  router.push("/master/karir/lowongan/create");
};
...
<template>
  <!-- Table -->
  <div class="mb-4">
    <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Lowongan</h1>
    <p class="text-sm text-gray-400">Master - Karir - Lowongan</p>
  </div>
  <div
  ...
  >
    ...
    <div class="space-y-4 mb-5">
      ...
      <div class="flex items-center justify-between">
        <h3 class="font-semibold text-gray-800 dark:text-white">Master Lowongan</h3>
      ...
      <div class="relative w-full md:w-80">
        ...
        <input
          v-model="search"
          type="text"
          placeholder="Cari Master Lowongan..."
      ...
      <table class="w-full text-sm">
        <thead>
          ...
          >
            ...
            <th class="px-2">Nama Lowongan</th>
            <th class="px-2">Unit Kerja</th>
            <th class="px-2">Kebutuhan</th>
            <th class="px-2">Tutup</th>
          ...
          >
            ...
            <td class="px-2">
              <div class="justify-center">
                <button
                  @click="$router.push(`/master/karir/lowongan/edit/${row.id}`)"

...
useHead({
  title: "Durante Operasi - Vanara Admin",
});
  ...
  >
    ...
    <div class="bg-emerald-500 dark:bg-emerald-600 rounded-2xl p-6 text-white shadow-lg">
      <div class="flex justify-between items-start">
        ...
        <div class="text-right">
          <p class="text-emerald-100 text-sm mb-1">Ruang</p>
    ...
    <div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          <h3 class="font-semibold text-slate-800 dark:text-slate-100 mb-1">Sign In</h3>
        ...
        <div
          class="bg-white dark:bg-slate-800 rounded-xl p-5 shadow-sm border border-slate-200 dark:border-slate-700 hover:shadow-md transition-shadow"
        >
          <h3 class="font-semibold text-slate-800 dark:text-slate-100 mb-1">Time Out</h3>
          <p class="text-sm text-slate-500 dark:text-slate-400 mb-4">
        ...
        <div
          class="bg-white dark:bg-slate-800 rounded-xl p-5 shadow-sm border border-slate-200 dark:border-slate-700 hover:shadow-md transition-shadow"
        >
          <h3 class="font-semibold text-slate-800 dark:text-slate-100 mb-1">Sign Out</h3>
          <p class="text-sm text-slate-500 dark:text-slate-400 mb-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      >
        ...
        <div v-if="!insisiStatus" class="flex flex-col items-center text-center">
          <div
        ...
        <div v-else class="flex flex-col items-center text-center">
          ...
          <p class="text-2xl font-semibold text-emerald-600 dark:text-emerald-400 mb-4">
            {{ insisiTime }}
          </p>
          <button
      ...
      >
        ...
        <div v-if="!pembiusanStatus" class="flex flex-col items-center text-center">
          <div
            class="w-16 h-16 rounded-full bg-amber-50 dark:bg-amber-900/30 flex items-center justify-center mb-3"
          >
            <svg

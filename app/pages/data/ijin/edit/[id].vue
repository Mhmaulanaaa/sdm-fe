...
<template>
  <div class="p-6 bg-gray-50 dark:bg-slate-900 min-h-screen">
    <!-- HEADER -->
    <div class="mb-4">
      <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Edit Ijin</h1>
      <p class="text-sm text-gray-400">Master - Ijin - Edit</p>
    </div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow p-6">
      ...
      <div class="flex justify-between items-center mb-6">
        <h2 class="font-semibold text-gray-700 dark:text-white">Edit Ijin</h2>

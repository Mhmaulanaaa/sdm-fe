...
const { addIjin } = useIjin();
useHead({
  title: "Tambah Data Ijin - SDM Admin",
});
...
const form = ref({
  nama_pegawai: undefined,
  model_ijin: undefined,
  jenis_ijin: undefined,
  tipe_ijin: undefined,
  shift_kerja: undefined,
  tanggal_buka: "",
  tanggal_tutup: "",
  file: null,
  lat: 0,
  ...
  <div class="p-6 bg-gray-50 dark:bg-slate-900 min-h-screen">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow p-6">
      ...
      <div class="flex justify-between items-center mb-6">
        <h2 class="font-semibold text-gray-700 dark:text-white">Tambah Ijin Baru</h2>
      ...
      <div class="grid md:grid-cols-2 gap-4">
        ...
        <!-- PEGAWAI -->
        <div>
          <label class="text-sm text-gray-600 dark:text-gray-300">Pegawai</label>
          <USelectMenu
            label="Pegawai"
        ...
        <!-- MODEL IJIN -->
        <div>
          <label class="text-sm text-gray-600 dark:text-gray-300">Model Ijin</label>
          <USelectMenu
            label="Model Ijin"
        ...
        <!-- JENIS IJIN -->
        <div>
          <label class="text-sm text-gray-600 dark:text-gray-300">Jenis Ijin</label>
          <USelectMenu
            label="Jenis Ijin"
        ...
        <!-- TIPE IJIN -->
        <div>
          <label class="text-sm text-gray-600 dark:text-gray-300">Tipe Ijin</label>
          <USelectMenu
            label="Tipe Ijin"
        ...
        <!-- SHIFT KERJA -->
        <div>
          <label class="text-sm text-gray-600 dark:text-gray-300">Shift Kerja</label>
          <USelectMenu
            label="Shift Kerja"
        ...
        <!-- BERKAS -->
        <div>
          <label class="text-sm text-gray-600 dark:text-gray-300">Upload Berkas</label>
          <BaseDropzone
            v-model="form.file"
        ...
        <!-- PILIH LOKASI -->
        <div>
          <label class="text-sm text-gray-600 dark:text-gray-300">Pilih Lokasi</label>
          <BaseLeaflet v-model:lat="form.lat" v-model:lng="form.lng" />
        </div>

        <!-- STATUS APPROVAL -->
        <div>
          <label class="text-sm text-gray-600 dark:text-gray-300">Status Approval</label>
          <USelectMenu

...
<template>
  ...
  >
    <!-- Header Card -->
    <div class="bg-emerald-500 dark:bg-emerald-600 rounded-2xl p-6 text-white shadow-lg">
      <h1 class="text-2xl font-bold">Laporan Operasi</h1>
      <p class="text-emerald-100 text-sm mt-1">Formulir dokumentasi prosedur operasi</p>
    </div>
      ...
      <div class="grid grid-cols-1 gap-4">
        ...
        <div>
          ...
          <select
            ...
            class="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-sm text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:focus:ring-emerald-600 dark:focus:border-emerald-600"
          >
            <option value="">Pilih kode ICD10</option>
          </select>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            ...
            class="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-sm text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:focus:ring-emerald-600 dark:focus:border-emerald-600"
          >
            <option value="">Bersih Kontaminasi</option>
          </select>
        </div>
        ...
        <div>
          ...
          <select
            ...
            class="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-sm text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:focus:ring-emerald-600 dark:focus:border-emerald-600"
          >
            <option v-for="opt in operationClasses" :key="opt" :value="opt">
              {{ opt }}
            </option>
          </select>
        </div>
        ...
        <div>
          ...
          <select
            ...
            class="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-sm text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:focus:ring-emerald-600 dark:focus:border-emerald-600"
          >
            <option v-for="opt in urgencyOptions" :key="opt" :value="opt">
              {{ opt }}
            </option>
          </select>
        </div>
    ...
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div>
          ...
          <select
            ...
            class="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-sm text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:focus:ring-emerald-600 dark:focus:border-emerald-600"
          >
            <option v-for="opt in roundOptions" :key="opt" :value="opt">
              {{ opt }}
            </option>
          </select>
        </div>
        ...
        <div>
          ...
          <select
            ...
            class="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-sm text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:focus:ring-emerald-600 dark:focus:border-emerald-600"
          >
            <option value="OK 100 - OK 100 - 002">OK 100 - OK 100 - 002</option>
          </select>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div>
          <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1"
            >6. Deskripsi / Uraian Operasi (Procedure performed and description)*</label
          >
          <textarea
        ...
        <div>
          <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1"
            >10. No. Registrasi Implant (registry number of implantable devices)*</label
          >
